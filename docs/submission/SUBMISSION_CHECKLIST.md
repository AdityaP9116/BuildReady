...
Official requirements and form fields were fetched live from Devpost on 2026-08-31.

## Ready locally

- [x] Public GitHub repository returned HTTP 200 without authentication.
- [x] MIT license committed.
- [x] Complete source and uv-only run instructions committed.
- [x] WebMCP registration code and working multi-stage implementation committed.
...
- [ ] Confirm country/countries of residence.
- [ ] Confirm App Status (`New` is the evidence-backed draft answer).
- [ ] Confirm learning level.
- [ ] Confirm whether the project provided reusable career AI value.
- [x] Confirm GitHub links and labels the repository's MIT license.
- [ ] Review the final Devpost preview for broken links, truncation, and image/video visibility.
