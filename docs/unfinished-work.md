...
2. **Geometry recognition and durable measurement review:** manufacturing inputs and SimScale face mappings currently require explicit human entry/review. The illustrative setup builder is limited to the inspected bracket. General-purpose geometry-to-role mapping and durable, versioned manufacturing reviews are not implemented; current browser measurement reviews are session-only.
