...
const { composeInsightResponse, classifyInsightQuery } = await import('../../web/insight-engine.js?v=20260903-3')
const { validateReviewReadiness } = await import('../../web/review-package.js?v=20260903-3')
const { fictionalQuotePreview } = await import('../../web/quote-engine.js?v=20260903-3')
const { reviewManufacturingInputs, REVIEW_GROUPS } = await import('../../web/manufacturing-review.js?v=20260903-3')
